#給我一段爬蟲的程式碼，先建立一個資料夾'M05A'在"C:\Users\waes3\Downloads"中
...
#然後刪除原本的壓縮檔
#最後合併所有的 csv 檔案，並將其儲存於'M05A'資料夾中
import os
import requests
import pandas as pd
...
# 建立資料夾
base_dir = "C:\\Users\\waes3\\OneDrive - cycu.org.tw\\文件\\Downloads\\M05A"
...
# 合併所有 CSV 檔案
dfs = [pd.read_csv(f"C:\\Users\\waes3\\OneDrive - cycu.org.tw\\文件\\Downloads\\M05A\\{filename}") for filename in os.listdir("C:\\Users\\waes3\\Downloads\\M05A0429") if filename.endswith('.csv')]
