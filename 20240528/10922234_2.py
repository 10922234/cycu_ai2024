# 用迴圈方式讀取此 CSV 檔案 從 "C:\\Users\\waes3\\OneDrive - cycu.org.tw\\文件\\Downloads\\M05A\\M05A_20240101.csv" C:\\Users\\waes3\\OneDrive - cycu.org.tw\\文件\\Downloads\\M05A\\M05A_20240430.csv"
# 並做以下處理 
...
# 4: 80 <= 速度 < 100
# 5:       速度 >= 100
# 存於此位置 "C:\Users\waes3\OneDrive - cycu.org.tw\文件\Downloads\M05A\特徵化過的M05A"，並命名為 "M05A_20240101_feature.csv"，"M05A_20240102_feature.csv"，...，"M05A_20240430_feature.csv"，每個檔案的內容為上述處理後的資料
...
# 迴圈讀取和處理每一個 CSV 檔案
for date in dates:
    # 讀取 CSV 檔案  從此 位置 讀取"C:\\Users\\waes3\\OneDrive - cycu.org.tw\\文件\\Downloads\\M05A"   
    data = pd.read_csv(f"C:\\Users\\waes3\\OneDrive - cycu.org.tw\\文件\\Downloads\\M05A\\M05A_{date.strftime('%Y%m%d')}.csv")
    ...
    #將檔案重新命名為'M05A_日期_feature'，並存檔於指定位置 "C:\Users\User\OneDrive\M05A\M05A特徵化"
    data.to_csv(f"C:\\Users\\waes3\\OneDrive - cycu.org.tw\\文件\\Downloads\\M05A\\M05A特徵化\\M05A_{date.strftime('%Y%m%d')}_feature.csv", index=False)
