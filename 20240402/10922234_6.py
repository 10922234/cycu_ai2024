...
#read shape file
df_taiwan=gpd.read_file('C:/Users/User/Documents/GitHub/cycu_ai2024/20240402/COUNTY_MOI_1090820.shp')
...
for x, y, label in zip(geo_taiwan.geometry.centroid.x, geo_taiwan.geometry.centroid.y, geo_taiwan['COUNTYNAME']):
    plt.text(x+ 0.1 , y+0.1, label, fontsize=8, ha='center')
    plt.rcParams['font.sans-serif'] = ['Arial Unicode MS']

plt.title('10922234_陳懿', fontproperties='Arial Unicode MS')

plt.show()

plt.savefig('/c:/Users/User/Desktop/geo_taiwan.png')