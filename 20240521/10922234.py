...
# 建立資料夾
os.makedirs('C:\\Users\\waes3\\Downloads\\M05A', exist_ok=True)
...
for date in date_range:
    ...
    if response.status_code == 200:
        ...
        tar_path = f'C:\\Users\\waes3\\Downloads\\M05A\\M05A_{date_str}.tar.gz'
    ...
    for hour in range(24):
        for minute in range(0, 60, 5):
            ...
            if response.status_code == 200:
                ...
                csv_path = f'C:\\Users\\waes3\\Downloads\\M05A\\TDCS_M05A_{date_str}_{hour:02d}{minute:02d}00.csv'
